        ...
        <>
            ...
            <div ref={tiltRef} className="glass-card tilt-card" style={{ padding: 0 }}>
                <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--border-color)', background: 'rgba(255, 255, 255, 0.02)' }}>
                    <h1 className="gradient-persona-text" style={{ margin: 0, fontSize: isMobile ? '1.4rem' : '2.2rem', fontWeight: '900', letterSpacing: '-0.03em' }}>
                        Your Persona
                    </h1>
                </div>
                <div className="persona-gradient-banner" style={{ height: '110px', background: 'linear-gradient(135deg, var(--primary-blue), var(--accent-green))', position: 'relative' }}>
                ...
                <div className="persona-content-wrapper">
                    <div className="persona-avatar-row" style={{ marginTop: '-105px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.5rem' }}>
                        <div style={{ display: 'flex', alignItems: 'flex-end', gap: '1rem' }}>
                            ...
                            {/* Social Links */}
                            <div ref={socialLinksRef} className="persona-social-links" style={{ transform: isMobile ? 'translateY(10px)' : 'translateY(-50px)' }}>
